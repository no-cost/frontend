    ...
    >
      ...
      <div class="mb-6">
        ...
        <input
          ...
          class="text-sm text-gray-500 dark:text-gray-400 file:mr-3 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-gray-100 dark:file:bg-gray-800 file:text-cyan-500 dark:file:text-cyan-400 hover:file:bg-gray-200 dark:hover:file:bg-gray-700 file:cursor-pointer"
