    ...
    >
      ...
      <template v-else>
        ...
        <p class="mb-8 text-sm text-center text-gray-400">
          This resets your <strong class="text-gray-300">settings panel</strong> password.
          To reset your instance's admin password, use the app's built-in password reset (at your site URL).
        </p>
